...
return [
    ...
    'timezone' => 'CST', // https://www.php.net/manual/en/timezones.php
    ...
    'frontend_config' => [
        ...
        'language' => 'chinese',
        'logo' => 'http://shuzang.xyz/?r=/download&path=L290aGVycy9lYm9va19wYW4vbG9nb190aW55LnBuZw%3D%3D',
        'upload_max_size' => 100 * 1024 * 1024, // 100MB
        'upload_chunk_size' => 1 * 1024 * 1024, // 1MB
        'upload_simultaneous' => 3,
        'default_archive_name' => 'archive.zip',
        'editable' => ['.txt', '.css', '.js', '.ts', '.html', '.php', '.json', '.md'],
        'date_format' => 'YYYY/MM/DD hh:mm:ss', // see: https://momentjs.com/docs/#/displaying/format/
    ...
    'services' => [
        ...
        'Filegator\Services\View\ViewInterface' => [
            ...
            'config' => [
                'add_to_head' => '',
                'add_to_body' => '<div align="center"><script type="text/javascript" src="https://v1.cnzz.com/z_stat.php?id=1279779722&web_id=1279779722"></script></div>',
            ],
        ],
