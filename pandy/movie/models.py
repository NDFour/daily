...
class Movie(models.Model):
    v_href = models.CharField('采集页链接', max_length=255)
    ...
    v_pass = models.CharField('密码', max_length=255)
    v_ed2k = models.CharField('磁力链接 1', max_length=255)
    v_magnet = models.CharField('磁力链接 2', max_length=255)
