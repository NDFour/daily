...
return [
     ...
     * Defualt value: 'en'
     */
    'language' => DI\env('APP_LANGUAGE', 'zh-CN'),
     ...
     */
    'site_title' => DI\env('SITE_TITLE', '书藏'),
     ...
     */
    'meta_description' => DI\env('META_DESCRIPTION', '个人自用网盘，无关人员请离开'),
     ...
     * Default value: true
     */
    'zip_downloads' => DI\env('ZIP_DOWNLOADS', false),
     ...
     */
    'timezone' => DI\env('TIMEZONE', 'Asia/Shanghai'),
     ...
     */
    'max_hash_size' => DI\env('MAX_HASH_SIZE', 100000000),
];
