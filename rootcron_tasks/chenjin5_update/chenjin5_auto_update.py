...
def is_crawled(origin_url):
    conn = pymysql.connect('127.0.0.1', port=3306, user='user', password='xxxxxxxx', db='datebase', charset='utf8')
    cursor = conn.cursor()
...
def save_2_db( sql_list ):
    conn = pymysql.connect('127.0.0.1', port=3306, user='user', password='xxxxxxxxx', db='database', charset='utf8')
    cursor = conn.cursor()
